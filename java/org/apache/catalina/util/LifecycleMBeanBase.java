...
public abstract class LifecycleMBeanBase extends LifecycleBase
    ...
    protected void initInternal() throws LifecycleException {
        ...
        // preRegister().
        // 如果 objectName 不是 null 就说明 已经通过 preRegister() 方法进行注册了
        if (oname == null) {
            // 注册一个 MBeanServer
            // Registry.getRegistry(null, null) LifecycleMBeanBase 使用同一个 mserver
            mserver = Registry.getRegistry(null, null).getMBeanServer();
            // ObjectName 会将当前组件注册进 Registry
    ...
    protected final ObjectName register(Object obj,
        ...
        // 使用 domain 域进行初始化对象名称
        // domain -> 使用 standardServer service[] 中的第一个 service(catalina)
        // 名称作为域名
