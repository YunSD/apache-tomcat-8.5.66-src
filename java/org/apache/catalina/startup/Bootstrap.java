...
public final class Bootstrap {
    ...
    static {
        ...
        // 如果找不到 catalina-home 目录 就会去寻找当前目录下的 bootstrap.jar
        if (homeFile == null) {
        ...
        // 第二次回退，当 catalina-home 与 bootstrap.jar 都找不到，就使用当前目录
        if (homeFile == null) {
        ...
        // 确定当前目录 并设置到 SystemProperty name : catalina.home
        catalinaHomeFile = homeFile;
        System.setProperty(
                Constants.CATALINA_HOME_PROP, catalinaHomeFile.getPath());

        // Then base
        // 查看当前有没有指定 catalina.base
        String base = System.getProperty(Constants.CATALINA_BASE_PROP);
        if (base == null) {
            // 如果 catalina.base 没有指定，就是用 catalina.home 作为 catalina.base
    ...
    /**
     * common.loader p:null -> application
     * server.loader p:common
     * shared.loader p:common
     * 各个 loader 所负责类加载区域不同
     */
    ...
    public void init() throws Exception {
        ...
        // 当前线程使用 catalinaLoader 作为类加载器
        Thread.currentThread().setContextClassLoader(catalinaLoader);

        // SecurityManager 使用 catalinaLoader 提前 加载 tomcat 容器必要的 class
        ...
        // 设置 Catalina 使用 sharedLoader 作为类加载器
    ...
    public static void main(String args[]) {
        ...
        synchronized (daemonLock) {
            if (daemon == null) {
                ...
                // 当多次运行 main 的时候（新线程），将对新线程设置 loader
        ...
        try {
            ...
            if (command.equals("startd")) {
                ...
                // daemon Catalina await 属性更改为 true
