    ...
    public void load() {
        ...
        try {
            ...
            try {
                ...
                // digester 将 this push to stack top
                digester.push(this);
                // 通过 digester 进行解析 inputSource(server.xml)
                // 解析完成后 catalina 中的 server：StandardServer 就存在了
        ...
        // 对解析 server.xml 生成的 StandardServer 进行一些属性填充
