...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel> {
    ...
    public void bind() throws Exception {
        // 是否需要使用 InheritedChannel
        // https://stackoverflow.com/questions/14180353/whats-use-of-inheritedchannel-method-in-system-class/14180418
        if (!getUseInheritedChannel()) {
            // open 服务器套接字
            serverSock = ServerSocketChannel.open();
            // serverSock.socket() 返回一个 ServerSocket 对象并进行设置
